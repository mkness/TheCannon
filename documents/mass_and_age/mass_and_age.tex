...
Age indicators have been found for stellar spectra previously and include the xxx emission in the xxx and the xxx in the UV. Mass or age may appear as information in the stellar spectra in a number of ways. It may appear as a dredge-up of evolved
material from the core into the photosphere (see Marc P's) email. It may appear as chromospheric emission from a time-dependent magnetic field or it may be reflected in the line-profile variations due to non-LTE effects as convection scales with mass. 
