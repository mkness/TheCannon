...
%plotdiff_5labels_10percent_linear.py
\begin{figure}[h!]
\centering
...
\begin{figure}[h!]
\centering
  \includegraphics[scale=0.31]{./plots/teff_coefficient.png}
  \includegraphics[scale=0.31]{./plots/logg_coefficient.png}
  \includegraphics[scale=0.31]{./plots/feh_coefficient.png}
  \includegraphics[scale=0.31]{./plots/alphafeh_coefficient.png}
