...
\starlabelvec_n \equiv  [1, \teff, \logg, \feh, \alphafe, \mbox{mass}, \teff^2, \\
 \teff\cdot\logg, \teff\cdot\feh, \teff\cdot\alphafe, \teff\cdot \mbox{mass} \\
 \logg^2, \logg\cdot\feh, \logg\cdot\alphafe, \logg\cdot \mbox{mass},  \\
\feh^2, \feh\cdot\alphafe, \feh\cdot \mbox{mass}, \alphafe^2, \alphafe\cdot \mbox{mass}, \mbox{mass}^2, \\\mbox{mass} \cot\alphafe, \logg^3]
\end{split}
%\end{aligned}
 \label{eq:quad}\quad.
%\end{eqnarray}
