...
\begin{figure}[!h]
\centering
  \includegraphics[scale=0.26]{./plots/aftersubmit/t_diff2.png}
    \includegraphics[scale=0.26]{./plots/aftersubmit/g_diff2.png}
    \includegraphics[scale=0.26]{./plots/aftersubmit/feh_diff2.png}
