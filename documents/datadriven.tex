...
The vast spectroscopic stellar surveys of recent years (e.g. SEGUE \citep{Beers2006}, RAVE \citep{Steinmetz2006}, LAMOST \citep{Newberg2012}, APOGEE \citep{Majewski2012}, Gaia-ESO \citep{Gilmore2012}, GALAH \citep{Freeman2012}) hold tremendous astrophysical promise, but at the same time present formidable data analysis and modeling challenges. 
...
\caption{\aspcap-corrected DR10 labels  for the training step in \teff-\logg\ plane for 545 stars in the 19 clusters for which parameters are provided by APOGEE \citep{Meszaros2013}. The age and \feh\ of the isochrones (in parentheses) is shown in each sub-panel. All labels adopted from DR10 except for the Pleiades. }
