...
Even when the input assumptions are held fixed, differences in how different parts of the spectrum are used lead to substantial differences in assigned labels \citep[e.g.][]{Hinkel2014}.
