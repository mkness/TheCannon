...
One of these challenges lies in consistently and accurately determining stellar labels, i.e. stellar parameters and element abundances, from survey spectra. 
...
The data we employ can be from any large survey, but here we use the \apogee\ data to showcase \tc . 
We describe how we prepare the training data for the label-transfer and similarly process the input test data.
