...
The general approach to the first but also the third issue is to expand the scope of the model. The model currently only generates spectra by providing a \textit{pdf}
