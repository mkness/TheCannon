...
\begin{figure}[!h]
\centering
  \includegraphics[scale=0.26]{./plots/aftersubmit/t_diff.png}
    \includegraphics[scale=0.26]{./plots/aftersubmit/g_diff.png}
    \includegraphics[scale=0.26]{./plots/aftersubmit/feh_diff.png}
