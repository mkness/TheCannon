...
For another, a post-calibration procedure is often applied after
...
any stellar survey.
Furthermore, the basic implementation of \tc\ presented here includes
only three labels, but this can easily be extended to additional
labels (for example, [$\alpha$/Fe], [X/Fe]) and also even more
flexible models (for example, Gaussian processes instead of
polynomials).
...
In using ell of the pixels in the spectrum to obtain the
