...
Exactly which stellar labels we adopt for theses reference objects is critical to the subsequent output, and hence we discuss it all in detail in \sectionname~\ref{sec:ApogeeRefLabels} .
