...
%\caption{\small{ASPCAP DR10 versus the Cannon for the 21,100 stars with stellar parameters available in DR10 with \tc\ $\chi^2$ cut $<$ 10.}}
%\label{fig:DR10_compare}
%\end{figure}
...
...application to some example \textit{APOGEE} targets and comparison to ASPCAP
