...
\begin{figure}[h!]
\centering
    \includegraphics[scale=0.33]{./plots/training_aspcap2.pdf}
...
\section{\tc 's Test Step: Making a Generative Model}
...
\hline
star ID  & \teff\ & \logg\ & \feh\ & $\sigma$(\teff) & $\sigma$(\logg) & $\sigma$(\feh) & $\chi^2$ & \tiny{VSCATTER} & \tiny{STAR BAD} & \tiny{TARG2}& \tiny{COMMIS} \\
