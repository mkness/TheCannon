...
HOGG: PART OF THE REASON FOR THIS IS: generative model!
PART OF THE REASON IS:  Good continuum estimation!
PART OF THE REASON IS:  Use all of the pixels.
...
Related to all this, one approximation we made in this implementation
is that the model is just a maximum-likelihood estimator.
It is built on a generative model, but we only optimize this model, we
...
[DWH: MAXIMIZING LIKELIHOOD INSTEAD OF BAYES]
