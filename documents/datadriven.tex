...
derived them for essentially all of the 56,000 DR10 survey stars, based on a training step that involved only 543 reference objects, i.e. 1\% of the survey.  Remarkably, \tc ~'s label transfer results in stellar parameter and metallicites that are as precise and accurate as those derived from
...
have simply no additional infomation on the labels of the survey objects. Yet,
