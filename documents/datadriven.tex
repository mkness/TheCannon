...
\caption{\textcolor{blue}{The four stars in Figure 3 across narrow wavelength intervals A and B, as described in section 2.3. The stars are plotted in black with the models in red, including the span of the scatter of the fit, generated by \tc. Spectral regions where the flux error is high ($>$ 5$\sigma$) are not shown.}}
\label{fig:modeldata}
\end{figure}
