...
\title{The Cannon: Wavelength-independent stellar parameter determination using data-driven models}
\author{
  MKN,
  DWH,
  \&
...
Assuming the input labels from the ASPCAP corrected parameters determined from calibrations to literature cluster values also wraps in the errors from the ASPCAP pipeline: of XX in Teff, XX in \logg\ and XX in [Fe/H], but does place The Cannon directly on the ASPCAP scale for comparison and analysis of the label transfer method.
