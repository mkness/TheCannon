...
\caption{The take-one-star-out cross-validation of the 545 stars \citep{Meszaros2013} for the training step using the quadratic model in Equation  \ref{eq:10}. The histograms at right show \tc\ output -- \apogee\ input labels.}
