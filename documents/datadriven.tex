...
\begin{figure}[h!]
\centering
    \includegraphics[scale=0.45]{./plots/takeout_histc.pdf}
...
\begin{figure}[h!]
\centering
    \includegraphics[width=\hsize]{./plots/R1_continuum5.pdf}
...
\begin{figure}[!h]
\centering
  \includegraphics[scale=0.25]{./plots/iso1_2.pdf}
  \hspace{-20pt}
    \includegraphics[scale=0.25]{./plots/iso1a_2.pdf}
...
\begin{figure}[!h]
\centering
 \includegraphics[scale=0.25]{./plots/iso2_2.pdf}
  \hspace{-20pt}
    \includegraphics[scale=0.25]{./plots/iso2a_2.pdf}
...
%run -i makecontin_data1_revc.py
 \begin{figure}[!h]
  \includegraphics[width=\hsize]{./plots/SNR_continuum6.pdf}
...
\bibitem[{{Sch{\"o}nrich} \& {Bergemann}(2014)}]{Sm2014}
