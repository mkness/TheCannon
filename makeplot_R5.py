...
ax1.set_title("REGION 5 USED FOR [Fe/H] INDEX") 
axlist = [ax1,ax2,ax3,ax4,ax5]
for each in axlist:
  each.plot([l1e-30,l2e+30], [0,0],'k--') 
ax4.plot([l1e-30, l2e+30],[1,1], 'k--') 

ax1.axvspan(l1e, l2e, facecolor='c', alpha=0.1)
ax2.axvspan(l1e, l2e, facecolor='c', alpha=0.1)
ax3.axvspan(l1e, l2e, facecolor='c', alpha=0.1)
ax4.axvspan(l1e, l2e, facecolor='c', alpha=0.1)
ax5.axvspan(l1e, l2e, facecolor='c', alpha=0.1)
