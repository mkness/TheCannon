...
ax3.plot(dataall[:, 0, 0], 1. * chisqs,color = 'red' ,linewidth = 2) # feh  
...
ax3.vlines(val0, -11,20000000, linestyle = 'dashed', linewidth = 2) 
ax4.vlines(val0, -1,2, linestyle = 'dashed', linewidth = 2) 
ax5.vlines(val0, -1,2, linestyle = 'dashed', linewidth = 2) 

ax2.set_xlim(l1e - 20, l2e + 20 ) 
ax1.set_ylim(-0.00046 ,0.00046) 
ax2.set_ylim(-0.5 ,0.5) 
ax3.set_ylim(-10000 ,1000000) 
ax4.set_ylim(0.6 ,1.2) 
ax5.set_ylim(-0.5 ,0.5) 
ax1.set_xlim(l1e - 20, l2e + 20 ) 
ax2.set_xlim(l1e - 20, l2e + 20 ) 
ax3.set_xlim(l1e - 20, l2e + 20 ) 
ax4.set_xlim(l1e - 20, l2e + 20 ) 
ax5.set_xlim(l1e - 20, l2e + 20 ) 
ax1.text(l1e-19, 0.00004, "Teff coeff" , fontsize = 12) 
ax2.text(l1e-19, 0.3, "log g coeff" , fontsize = 12) 
ax3.text(l1e-19, 800000.0, "chi2  coeff" , fontsize = 12) 
ax4.text(l1e-19, 1.1, "mean spectra" , fontsize = 12) 
ax5.text(l1e-19, 0.3, "[Fe/H]  coeff, log g coeff, Teff coeff*1000" , fontsize = 12) 
