...
axScatter.plot([-5,5], [-5,5],'k',linewidth = 2) 
...
axHisty.set_ylim(-5,5) 
axScatter.set_ylim(-1,5) 
axHisty.set_ylim(-1,5) 
axHistx.set_xlim(0,5) 
axScatter.set_xlabel("ASPCAP logg", fontsize = 20)
axScatter.set_ylabel("NHR+ logg", fontsize = 20) 
axHistx.set_title("calibrators: logg", fontsize = 20 ) 
#axHisty.set_ylabel("[Fe/H] hisogram of NHR+ [Fe/H]", fontsize = 20) 
axHisty.yaxis.set_label_position("right")
draw()
show()
savefig('/Users/ness/Downloads/Apogee_Raw/calibration_apogeecontinuum/documents/plots/cal_logg.eps', transparent=True, bbox_inches='tight', pad_inches=0.2)
