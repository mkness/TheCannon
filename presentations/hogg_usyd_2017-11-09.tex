...
\date{Hunstead Lecture -- 2017 November 9}
...
\begin{frame}
  \frametitle{\tc: label transfer from \apogee\ to \project{\acronym{LAMOST}} (Casey, Ho)}
...
\begin{frame}
  ...
  \item de-noising \project{Gaia}: Anderson \etal, arXiv:1706.05055
    \begin{itemize}
