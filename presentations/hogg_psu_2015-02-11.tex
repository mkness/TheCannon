...
\begin{frame}
  ...
  ~\hfill\includegraphics<1>[height=\figureheight]{../documents/paper1/plots/SNR100to200.png}
         \includegraphics<3>[height=\figureheight]{../documents/paper1/plots/SNR20to30.png}
\end{frame}
...
\begin{frame}
  ...
  \item \kepler\ and \project{K2} lightcurves
  \item CMB foregrounds
  \end{itemize}
\end{frame}

\begin{frame}
  \textsl{[ask me about \emph{20 new extra-solar planets} in \project{K2}]}
\end{frame}
