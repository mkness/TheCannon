...
\title{Detailed chemical abundances of stars}
...
\begin{frame}
  \frametitle{\tc: label transfer from \apogee\ to \project{\acronym{LAMOST}}}
...
\begin{frame}
  ...
  \item chemical abundances: \emph{Casey} \etal, arXiv:tomorrow
  \end{itemize}
\end{frame}
